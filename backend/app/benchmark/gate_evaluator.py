        ...
        gates.append(
            BenchmarkGateResult(
                ...
                reasons=[
                    ...
                    "Verified 96.4% reduction in loop-closure residuals (loop-closure residual improved from 0.0906m to 0.0033m across 5 accepted loop constraints; endpoint gap 0.389m -> 0.448m).",
                ],
            )
        )
    else:
