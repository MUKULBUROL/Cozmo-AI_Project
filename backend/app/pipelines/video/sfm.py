...
def run_visual_sfm(
    ...
    inc_opts.mapper.init_min_num_inliers = 10
    inc_opts.mapper.init_min_tri_angle = 1.2
    inc_opts.mapper.init_max_reg_trials = 5
    inc_opts.mapper.max_reg_trials = 5
    inc_opts.mapper.abs_pose_min_num_inliers = 4
    inc_opts.mapper.abs_pose_min_inlier_ratio = 0.05
    inc_opts.mapper.ba_local_min_tri_angle = 1.2
    inc_opts.mapper.filter_min_tri_angle = 0.4
